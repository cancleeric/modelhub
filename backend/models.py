...
class Submission(Base):
    ...
    # --- M16: 訓練曲線（逐 epoch JSON array）---
    epoch_curve = Column(String, nullable=True)  # TEXT JSON: [{"epoch":1,"train_loss":0.8,"map50":0.3,...},...]
    # --- 時間戳記 ---
...
_MIGRATIONS = [
    ...
    # M18-1: Cross-Resource Auto Retry — TrainingQueue 新增 attempted_resources
    ("training_queue", "attempted_resources",  "TEXT DEFAULT '[]'"),
    # M18-4: 系統事件日誌（events 表由 create_all 建立，此列佔位）
]
